    ...
    <section>
      <div className="bg-muted/50 py-24">
        <div className="mx-auto w-full max-w-5xl px-6">
          <div>
            <span className="text-primary text-sm sm:text-base font-medium">AI-Powered Generation</span>
            <h2 className="text-foreground mt-3 sm:mt-4 text-2xl sm:text-3xl md:text-4xl font-semibold leading-tight sm:leading-tight text-balance">From Prompt to Production-Ready APIs</h2>
          ...
          <div className="border-foreground/5 space-y-8 sm:space-y-12 [--color-border:color-mix(in_oklab,var(--color-foreground)10%,transparent)] sm:divide-y">
            <div className="grid gap-6 sm:gap-8 sm:grid-cols-5">
              ...
              <div className="order-1 sm:order-2 sm:col-span-3 sm:pl-8 lg:pl-12">
                <h3 className="text-foreground text-lg sm:text-xl font-semibold leading-tight">Multi-Framework Code Generation</h3>
            ...
            <div className="grid gap-6 sm:gap-8 sm:grid-cols-5 sm:pt-8 lg:pt-12">
              <div className="sm:col-span-3 sm:pr-8 lg:pr-12">
                <h3 className="text-foreground text-lg sm:text-xl font-semibold leading-tight">Auto-Generated Documentation</h3>
                <p className="text-muted-foreground mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg leading-relaxed">
...
export const ScheduleIllustation = ({ className, variant = "elevated" }: IllustrationProps) => {
  return (
    <div className={cn("relative flex flex-col items-center justify-center min-h-[200px] sm:min-h-[250px]", className)}>
      <div
        className={cn(
      ...
      >
        ...
        <ToggleGroup type="multiple" size="sm" className="gap-0.5 *:rounded-md">
          <ToggleGroupItem value="bold" aria-label="Toggle bold" className="h-6 w-6 sm:h-8 sm:w-8">
            <Bold className="size-3 sm:size-4" />
          </ToggleGroupItem>
          <ToggleGroupItem value="italic" aria-label="Toggle italic" className="h-6 w-6 sm:h-8 sm:w-8">
            <Italic className="size-3 sm:size-4" />
          </ToggleGroupItem>
          <ToggleGroupItem value="underline" aria-label="Toggle underline" className="h-6 w-6 sm:h-8 sm:w-8">
            <Underline className="size-3 sm:size-4" />
          </ToggleGroupItem>
          <ToggleGroupItem value="strikethrough" aria-label="Toggle strikethrough" className="h-6 w-6 sm:h-8 sm:w-8">
      ...
      <div className="text-center px-2">
        <span className="text-xs sm:text-sm">
          <span className="bg-secondary text-secondary-foreground py-1 px-2 rounded text-xs sm:text-sm">OpenAPI 3.0 spec</span> is our priority.
        </span>
      </div>
    </div>
  )
...
export const CodeIllustration = ({ className }: { className?: string }) => {
  return (
    <div
      className={cn("[mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_50%,transparent_100%)] flex justify-center items-center min-h-[200px] sm:min-h-[250px]", className)}
    >
