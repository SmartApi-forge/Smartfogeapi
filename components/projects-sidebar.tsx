...
export function ProjectsSidebar({ isOpen, onClose, searchQuery: externalSearchQuery, setSearchQuery: externalSetSearchQuery }: ProjectsSidebarProps) {
          ...
          <div className="flex items-center justify-between p-4 border-b border-[#2A2D31]/60 bg-gradient-to-r from-[#1E2125] to-[#1A1D21]">
            <div className="flex items-center">
              <h2 
                ...
                style={{ fontFamily: "'__flecha_df5a44', '__flecha_Fallback_df5a44'" }}
              >
                My Projects
              </h2>
            </div>
