...
export const ProjectSchema = z.object({
  ...
  framework: z.enum(['fastapi', 'express', 'nextjs', 'react', 'vue', 'angular', 'flask', 'django', 'python', 'unknown']),
  status: z.enum(['pending', 'generating', 'testing', 'deploying', 'deployed', 'failed']),
