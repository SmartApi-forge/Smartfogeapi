...
export const messagesRouter = createTRPCRouter({
   ...
   * Get a message by ID
   */
  getById: baseProcedure.input(GetMessageSchema).query(async ({ input }) => {
   ...
   */
  getAll: baseProcedure.input(GetMessagesSchema).query(async ({ input }) => {
    const params = {
   ...
   * Delete a message
   */
  delete: baseProcedure.input(GetMessageSchema).mutation(async ({ input }) => {
