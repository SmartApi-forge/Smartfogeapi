...
═══════════════════════════════════════════════════════════════════════════════
OPENAPI 3.1 SPECIFICATION (CRITICAL - MUST GENERATE)
═══════════════════════════════════════════════════════════════════════════════

⚠️ YOU MUST GENERATE A COMPLETE OpenAPI 3.1 spec in docs/openapi.yaml ⚠️

This is NOT optional. The OpenAPI spec must include:
- All paths with full request/response definitions
